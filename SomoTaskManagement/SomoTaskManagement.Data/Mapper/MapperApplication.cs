...
namespace SomoTaskManagement.Data.Mapper
{
    public class MapperApplication : Profile
    {
        public MapperApplication()
        {
            ...
            .ForMember(dest => dest.ReceiverName, opt => opt.MapFrom(src => src.Member.Name))
            ...
            CreateMap<TaskType, TaskTypeModel>()
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src =>
                 ((PlantLivestockEnum)src.Status) == PlantLivestockEnum.TaskPlant ? "TaskPlant" : "TaskLivestock"));
